...
public abstract MSOutputPrint  printChar (byte x);		// print byte as a character
public abstract MSOutputPrint  print (byte x);			// print byte as a number
...
public abstract MSOutputPrint  print (boolean x);
public abstract MSOutputPrint  print (long x);
public abstract MSOutputPrint  print (double x);
...
public MSOutputPrint  printCharSymbol (byte b)
{
...
public MSOutputPrint printIntsToChars (int [] ints, int start, int numChars)
{
